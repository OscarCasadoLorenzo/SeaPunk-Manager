...
This document explains the testing setup for the SeaPunk Manager monorepo, including how to run tests, view coverage reports, and add tests to new packages.
...
The SeaPunk Manager uses a unified testing workflow across the entire monorepo:
