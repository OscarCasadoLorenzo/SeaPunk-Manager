...
- **Components** - PascalCase: `UserProfile.tsx`, `CharacterList.tsx`
- **Utilities/Hooks** - camelCase: `useCharacters.ts`, `formatDate.ts`
- **Pages (Next.js App Router)** - lowercase: `page.tsx`, `layout.tsx`, `loading.tsx`

### Hooks

- **Custom hooks** start with `use`: `useAuth`, `useCharacters`
