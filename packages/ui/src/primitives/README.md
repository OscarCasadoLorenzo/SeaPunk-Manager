...
This directory contains primitive UI components based on [shadcn/ui](https://ui.shadcn.com/), a collection of re-usable components built with Radix UI and Tailwind CSS. These components provide the foundational building blocks for the SeaPunk Manager application interface.
