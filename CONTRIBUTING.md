...
SeaPunk Manager is in early development (prototyping) stage, the codebase hasn't been optimized yet. It is gradually being refactored, changing and breaking some things, so you might encounter code conflicts.
...
- Go to the [Issues](https://github.com/OscarCasadoLorenzo/SeaPunk-Manager/issues) section.
- Click on `New Issue`
...
- Navigate to the [Issues](https://github.com/OscarCasadoLorenzo/SeaPunk-Manager/issues) section.
- Click on `New Issue`
...
2. **Clone your fork locally**
   ...
   ```bash
   git clone https://github.com/<your-username>/SeaPunk-Manager.git
   cd SeaPunk-Manager
   ```
...
- [SeaPunk Manager Kanban Board](https://github.com/users/OscarCasadoLorenzo/projects/18)
